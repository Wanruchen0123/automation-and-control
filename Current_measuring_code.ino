...
void loop() {
  ...
  if (difTime >= 1000) {
    ...
    double Vinst = read_voltage() - 1.62;
    ...
    quadratic_sum_rms += (Iinst*Iinst)*difTime/100000;
    //quadratic_sum_v = ;
    //Serial.println(quadratic_sum_rms);
    //=================================================================================================================================
  ...
  if (quadratic_sum_counter >= sampleDuration) {
    ...
    double Irms =sqrt(quadratic_sum_rms*50) ;
    //Serial.println(Irms);
    //double Vrms = ;
    //=================================================================================================================================
  ...
  if (accumulated_counter >= sampleAverage) {
    ...
    double Irms_filt = accumulated_current/accumulated_counter;
